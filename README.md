...
| **2**  | Account Recovery & Home page Module | **Page**:  <br> - [pages layout](./frontend/app/(auth)/_layout.jsx) <br> -[Home Page](./frontend/app/(auth)/Home.jsx)  <br> - [Log Out session](./frontend/app/(auth)/profile.jsx)<br>- [Forgot pasword page](./frontend/app/(auth)/forgotPassword.jsx)<br> -[Enter OTP page](./frontend/app/(auth)/enterOTP.jsx)<br> -[Reset Password page](./frontend/app/(auth)/resetPassword.jsx)<br>**Component**: <br> - [Log Out button](./frontend/app/(auth)/profile.jsx)<br>- [Forgot pasword form](./frontend/app/(auth)/forgotPassword.jsx)<br> -[Enter OTP form](./frontend/app/(auth)/enterOTP.jsx)<br> -[Reset Password form](./frontend/app/(auth)/resetPassword.jsx)<br>**Service**:  <br> - [Password service](./frontend/services/passwordService.js) | **Controller**: <br> - [Password Controller](./backend/controllers/passwordController.js) <br> **Routes**: <br> - [password Route](./backend/routes/passwordRoute.js) <br>|
