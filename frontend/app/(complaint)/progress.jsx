...
import { SafeAreaView, ScrollView, View, Text, Image, TouchableOpacity, Alert, ToastAndroid, ActivityIndicator } from 'react-native';
  ...
  return (
    ...
    <SafeAreaView className="w-screen flex-1 bg-primary-500">
      <ScrollView className="mb-20">
        ...
        <View className="flex-row items-center m-4 px-4 py-6 rounded-lg bg-primary-100 mr-4">
          {/* Image on the Left */}
